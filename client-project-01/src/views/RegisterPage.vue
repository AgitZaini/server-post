        ...
        <div class="row px-3">
            <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
                ...
                <div class="card-body">
                    ...
                    <form class="form-box px-3" @submit.prevent="handleRegister">
                        <div class="form-input">
                            <span><i class="fa fa-envelope"></i></span>
                            <input type="text" v-model="name" tabindex="10" required name="" placeholder="Name" id="" />
                        </div>
                        <div class="form-input">
                            <span><i class="fa fa-envelope"></i></span>
                        ...
                        <div class="form-input">
                            <span><i class="fa fa-key"></i></span>
                            <input type="text" v-model="imgUrl" tabindex="10" required name="" placeholder="Image Url" id="" />
                        </div>
                        ...
                        <div class="text-center mb-2">
                            Do you have account?
                            <a href="#" class="register-link"><router-link to="/login">Login here </router-link></a>
                        </div>
                    </form>
                </div>
            </div>
